...
internal fun TaskContainer.createListAvailablePublicationTask(): ListAvailablePublicationTasks {
    return create("androidArtifactGeneratedPublications", ListAvailablePublicationTasks::class.java)
}
